...
Being an open source project, everyone is free to take a look at their codes and implementation, heres a few insights:
*Uses IKEv2 tunneling protocol
*Robust encruption usnig the following cipher suite: AES-GCM, SHA2 HMAC, and P-256 DH 
